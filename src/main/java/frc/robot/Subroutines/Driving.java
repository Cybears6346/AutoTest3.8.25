...
public class Driving {
    SparkMax m_frontRight = new SparkMax(2, MotorType.kBrushless); //states the existance of a sparkmax with a CANid of 4
    SparkMax m_rearRight = new SparkMax(1, MotorType.kBrushless); //states the existance of a sparkmax with a CANid of 3
    SparkMax m_rearLeft = new SparkMax(3, MotorType.kBrushless); //states the existance of a sparkmax with a CANid of 1
    SparkMax m_frontLeft = new SparkMax(4, MotorType.kBrushless); //states the existance of a sparkmax with a CANid of 2
    ...
    public void ManualDrive (double speed, double rotation, boolean square){
        ...
        double rotationPercentage = 1.0; //range 0.0 to 1.0 
    ...
    public void AutoDrive (double speed, double rotation){
        double speedPercentage = 0.40; //range 0.0 to 1.0
        double rotationPercentage = 0.4; //range 0.0 to 1.0
